...
Finally, join the mailing list by sending a message to  [dev-subscribe@s2graph.incubator.apache.org](mailto:dev-subscribe@s2graph.incubator.apache.org?subject=send this email to subscribe)!
...
* [users@s2graph.incubator.apache.org](mailto:users@s2graph.incubator.apache.org) is for usage questions, help and announcements.
